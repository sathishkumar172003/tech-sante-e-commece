...
Revision ID: 27e840e0de4d
Revises: eeaf520961e9
Create Date: 2022-12-19 21:22:22.517690
...
revision = '27e840e0de4d'
down_revision = 'eeaf520961e9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('customer_order', schema=None) as batch_op:
        batch_op.add_column(sa.Column('delivery_date', sa.String(length=50), nullable=False))
